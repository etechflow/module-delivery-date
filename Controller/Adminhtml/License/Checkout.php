 ...
 * Stores -> Config -> eTechFlow -> Delivery Date -> Payment Settings,
...
class Checkout extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        if (!$plan) {
            ...
            return $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('etechflow_dd/license/gate');
        }
        ...
        if (!$stripeKey || str_starts_with($stripeKey, '****')) {
            $this->messageManager->addErrorMessage(
                __('Stripe Secret Key is not configured. Go to Stores -> Config -> eTechFlow -> Delivery Date -> Payment Settings.')
            );
            return $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('etechflow_dd/license/gate');
        }
