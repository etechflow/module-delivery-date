...
namespace ETechFlow\DeliveryDate\Model\Performance;

/**
 * Thin profiler-tagging helper for the DD module's hot paths.
 *
 * Wraps Tideways span calls so traces captured in production are filterable
 * by `ETechFlow_DD_*` instead of relying on Magento's class-name auto-trace.
...
final class Profiler
{
     ...
     *
     * The returned handle is opaque — only pass it to stop().
     *
