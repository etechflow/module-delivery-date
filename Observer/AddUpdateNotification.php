 ...
 * of Delivery Date is published to the eTechFlow private Composer repo. Fires when
 * the admin opens the module's admin area. Re-added if dismissed; never duplicated
 * while an active entry for the same version exists. Fail-safe.
 */
class AddUpdateNotification implements ObserverInterface
{
    private const PACKAGE     = 'etechflow/module-delivery-date';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-delivery-date.json';
    private const CACHE_KEY   = 'etechflow_dd_latest_version';
    private const CACHE_TTL   = 21600;
    private const LABEL       = 'Delivery Date';
